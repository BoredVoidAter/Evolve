...
public class SkeletonVisualizer : MonoBehaviour
{
    ...
    private void BuildBoneRecursive(SimBone simBone, Transform parentTransform)
    {
        ...
        Color boneColor = simBone.IsEndEffector ? Color.red : Color.cyan;
        ...
        // FIX: If this is an end effector, add a dummy object at the exact tip location.
        // This is what the ProceduralLocomotion script now searches for to bind the IK target logic.
