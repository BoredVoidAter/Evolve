...
public class HexGridVisualizer : MonoBehaviour
{
    ...
    private List<HexTileInfo> _hexTiles = new List<HexTileInfo>();
    ...
    void Start()
    {
        ...
        UnderwaterRendererFeature.IsActive = false;
    }
    ...
    public void RenderGrid(HexGridData data)
    {
        ...
        foreach (var kvp in data.cells)
        {
            ...
            info.originalElevation = cell.elevation;
            info.originalBiome = cell.biome;
            info.meshFilter = mf;
            ...
            if (_decorationDict.TryGetValue(cell.biome, out GameObject prefab) && prefab != null)
            {
                ...
                info.decorationInstance = decoration;
            }
    ...
    public void SetUnderwaterMode(bool underwater)
    {
        ...
        // Toggle our Global Custom Scriptable Renderer Feature
        UnderwaterRendererFeature.IsActive = underwater;
        ...
        foreach (var tile in _hexTiles)
        {
            ...
            bool isCut = underwater && tile.originalElevation > maxWaterHeight;
            ...
            if (tile.meshFilter != null && tile.meshFilter.mesh != null)
            {
                ...
                Vector4[] uv1 = new Vector4[mesh.vertexCount];
                float biomeIndex = isCut ? 11f : (float)tile.originalBiome;
                
                for (int i = 0; i < uv1.Length; i++)
                {
                    uv1[i] = new Vector4(biomeIndex, 0, 0, 0);
                }
                mesh.SetUVs(1, uv1);
            }
